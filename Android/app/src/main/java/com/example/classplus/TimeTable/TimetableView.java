...
import com.example.classplus.TimeTable.HighlightMode;
import com.example.classplus.TimeTable.SaveManager;
...
public class TimetableView extends LinearLayout {
    ...
    private com.example.classplus.TimeTable.HighlightMode highlightMode = com.example.classplus.TimeTable.HighlightMode.COLOR;
    ...
    private void add(final ArrayList<Schedule> schedules, int specIdx) {
        ...
        for (Schedule schedule : schedules) {
            ...
            tv.setBackgroundColor(Color.parseColor(schedule.getColor()));
